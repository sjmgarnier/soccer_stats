...
Now, the question for all Liverpool fans is: will it last, and for how long? Liverpool has not won a top-flight championship since 1990, and in the meantime a number of teams has started catching up with the Red Devils, both in the number of titles won ([Manchester United](http://www.manutd.com) is actually ahead of Liverpool since 2011) and in the total number of wins. 
